...
Strongly damped large-screen growth.

## Formula / behavior

symmetric logarithmic correction around baseline.
...
let value = DynamicDimens.resolve(16, strategy: .logarithmic, configuration: configuration)
```
